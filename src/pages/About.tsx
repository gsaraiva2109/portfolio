...
export const About = () => {
  ...
  const philosophyPoints = [
    ...
    },
    {
      ...
      description: 'Treat servers like cattle, not pets. I define infrastructure in code to prevent configuration drift and guarantee reproducibility.',
    },
    {
      icon: MapPin,
      title: 'Platform Agnostic',
      description: 'Cloud or Bare Metal. I build resilient, containerized architectures that run reliably anywhere, adapting to business needs.',
    },
  ];
              ...
              <div className="bg-bg-elevated border border-neutral-700 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-primary-500 font-mono">Early career</span>
                  </div>
                  <div className="flex items-center justify-between">
